/**
 * Edit Competitor page - Form to update existing competitor
 */
...
export function EditCompetitor() {
  ...
  const loadCompetitor = async () => {
    try {
      ...
      const competitor = await CompetitorIntelligenceAPI.getCompetitor(id!);
      ...
      setFormData({
        ...
        platforms: Array.isArray(competitor.platforms) ? competitor.platforms : [],
        monitoringKeywords: Array.isArray(competitor.monitoringKeywords) ? competitor.monitoringKeywords : []
      });
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await CompetitorIntelligenceAPI.updateCompetitor(id!, formData);
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Edit Competitor</h1>
              <p className="mt-2 text-gray-600">Update competitor profile and monitoring settings</p>
            </div>
          </div>
        </div>
      </div>
